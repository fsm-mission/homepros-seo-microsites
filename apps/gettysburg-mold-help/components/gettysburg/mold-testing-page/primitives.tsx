...
/**
 * Neutral, restrained list used across the mold-testing page.
...
export function ContextualLink({
  ...
  if (!live) {
    ...
    return <span className="font-medium text-site-fg underline decoration-site-border underline-offset-4">{children}</span>
  }
  return (
    <Link
      href={href}
